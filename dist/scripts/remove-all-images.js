...
async function removeAllImages() {
    try {
        ...
        const subcategoryResult = await Subcategory.updateMany({}, { $set: { images: [] } });
        ...
        const promoResult = await PromoCard.updateMany({}, { $set: { image: "" } });
        ...
        const mfgBannerResult = await ManufacturerBanner.updateMany({}, { $set: { image: "" } });
        ...
        const siteSettingsResult = await SiteSettings.updateMany({}, { $set: { "logos": [] } });
