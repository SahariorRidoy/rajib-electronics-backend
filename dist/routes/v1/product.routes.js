...
router.get("/products", validateQuery(ProductListQuery), async (req, res, next) => {
    try {
        ...
        const projection = "_id title slug image images price buyingPrice compareAtPrice stock availableStock categorySlug subcategorySlug brand manufacturerSlug description status colorVariants createdAt";
